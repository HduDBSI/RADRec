...
def get_args():
    ...
    parser.add_argument("--low_coupling_ratio", type=float, default=0.05,
                        help="ratio used to identify low-coupling sequences before entropy grouping")
...
if __name__ == '__main__':
    ...
    if args.low_coupling_ratio < 0 or args.low_coupling_ratio > 1:
        raise ValueError("The low coupling ratio must be in [0, 1].")
    ...
    if args.eval_only:
        ...
        scores, log_info = trainer.test(0)
